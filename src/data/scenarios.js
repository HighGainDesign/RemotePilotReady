const scenarios = [
  {
    ...
    options: [
      { text: "Yes, no restrictions apply", correct: false },
      { text: "Yes, but you must comply with Operations Over People rules", correct: true },
      { text: "No, you cannot fly over people under any circumstances", correct: false },
      { text: "No, you need a waiver for urban areas", correct: false }
    ],
  ...
  },
  {
    ...
    options: [
      { text: "No, it's after civil twilight so no flying is allowed", correct: false },
      { text: "Yes, anti-collision lights visible for 3 SM allow night operations", correct: true },
      { text: "Yes, Part 107 has no time-of-day restrictions", correct: false },
      { text: "No, you need a separate night waiver in addition to lights", correct: false }
    ],
  ...
  },
  {
    ...
    options: [
      { text: "Just the airport's written permission is sufficient", correct: false },
      { text: "FAA airspace authorization via LAANC or DroneZone, plus coordination with ATC", correct: true },
      { text: "A Part 107 waiver for airport operations", correct: false },
      { text: "No authorization needed since the airport invited you", correct: false }
    ],
  ...
  },
  {
    ...
    question: "Can you fly this mission?",
    options: [
      { text: "Yes, Class G has no weather minimums", correct: false },
      { text: "No, visibility is below the 3 SM minimum", correct: true },
      { text: "Yes, as long as you stay below the clouds", correct: false },
      { text: "No, because it's during civil twilight", correct: false }
    ],
  ...
  },
  {
    ...
    options: [
      { text: "Yes, emergency situations override all restrictions", correct: false },
      { text: "Yes, but only if the incident commander authorizes your operation within the TFR", correct: true },
      { text: "No, all drone flights are prohibited in a TFR", correct: false },
      { text: "Yes, Part 107 pilots are automatically authorized for emergency support", correct: false }
    ],
  ...
  },
  {
    ...
    options: [
      { text: "400 feet AGL, no exceptions", correct: false },
      { text: "500 feet AGL since that's the top of the structure", correct: false },
      { text: "Up to 900 feet AGL (400 feet above the 500-foot structure), as long as you stay within 400 feet of the structure", correct: true },
      { text: "No altitude limit when inspecting structures", correct: false }
    ],
  ...
  },
  {
    ...
    options: [
      { text: "Yes, you can fly two drones if you have an assistant", correct: false },
      { text: "Yes, Part 107 allows multiple drones for agricultural use", correct: false },
      { text: "No, one pilot cannot operate more than one drone at a time without a waiver", correct: true },
      { text: "Yes, as long as both drones stay within VLOS", correct: false }
    ],
  ...
  },
  {
    ...
    question: "Can you fly this mission?",
    options: [
      { text: "Yes, Class G airspace means no restrictions", correct: false },
      { text: "No, stadiums with 30,000+ people have a TFR during events", correct: true },
      { text: "Yes, if your drone meets Category 4 for operations over people", correct: false },
      { text: "Yes, with a standard Part 107 waiver", correct: false }
    ],
  ...
  },
  {
    ...
    options: [
      { text: "Yes, there are no restrictions on crossing highways", correct: false },
      { text: "No, flying over moving vehicles requires a waiver or Operations Over People category compliance", correct: true },
      { text: "Yes, as long as the drone weighs under 55 lbs", correct: false },
      { text: "No, Part 107 prohibits all package delivery", correct: false }
    ],
  ...
  },
  {
    ...
    options: [
      { text: "No reporting required since no one was hurt and the owner isn't pressing charges", correct: false },
      { text: "File a police report within 24 hours", correct: false },
      { text: "Report to the FAA within 10 calendar days since property damage exceeds $500", correct: true },
      { text: "Report to the NTSB immediately", correct: false }
    ],
